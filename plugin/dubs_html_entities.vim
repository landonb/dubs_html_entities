...
function s:GetHctLookup_14bits()
  ...
  let HctLookup = [
    ...
    \ {'nbr': 338, 'sym': '', 'ent': '&OElig;', 'desc': "latin capital ligature OE"},
    \ {'nbr': 339, 'sym': '', 'ent': '&oelig;', 'desc': "latin small ligature oe"},
    \ {'nbr': 352, 'sym': '', 'ent': '&Scaron;', 'desc': "latin capital letter S with caron"},
    \ {'nbr': 353, 'sym': '', 'ent': '&scaron;', 'desc': "latin small letter s with caron"},
    \ {'nbr': 376, 'sym': '', 'ent': '&Yuml;', 'desc': "latin capital letter Y with diaeresis"},
    \ {'nbr': 402, 'sym': '', 'ent': '&fnof;', 'desc': "latin sm. f w/ hook, function, florin"},
    \ {'nbr': 710, 'sym': '', 'ent': '&circ;', 'desc': "modifier letter circumflex accent"},
